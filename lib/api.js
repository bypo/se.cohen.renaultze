...
class RenaultApi {
        ...
        /*
            {
                ...
                data: {
                    country: 'SE',
                    locale: 'sv-SE',
                    accountId: '54cc7a4d-28a4-4a16-bda8-13e3c4727a89'
                }
            }
        */
    ...
    async getDevices() {
        ...
        /* 
            { status: 'ok', data: [ { vin: 'VF1AG000164767503' } ] }
        */
    ...
    async _gigyaLogin() {
        ...
        return axios.post(
            ...
            querystring.stringify({ ApiKey: self.configuration.gigya_api_key, loginID: self.settings.username, password: self.settings.password }))
            .then(response => {
